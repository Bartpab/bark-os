...
#define KBD_CALLBACK_SIZE 0xFF

struct kbd_event_reg_t {
        u16 limit;
        u16 cursor;
};
...
typedef void (*kbd_callback_t) (const struct kbd_event);
...
#ifdef __KBD__
        struct kbd_event_reg_t kbdeventr;
        kbd_callback_t kbdcallbacks[KBD_CALLBACK_SIZE];
        uchar kbdmap[] = {
